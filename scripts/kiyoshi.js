...
Being
    .kingdom({name: 'animal', generic: true})
        ...
        .phylum({name: 'blue dragon', symbol: '龍', lean_mass: 2000, vigor: 200, attacks: [{burn: 9}], can_fly: true, inventory: {width: 1, height: 3}})
...
Square
    .kingdom({name: 'ground', symbol: '土', continuous: true, walkable: true, flyable: true, generic: true})
        ...
        .phylum({name: 'downward staircase', symbol: '＞', can_descend: true, clumpiness: 0})
        .phylum({name: 'upward staircase', symbol: '＜', can_ascend: true, clumpiness: 0})
...
initialize = function() {
    ...
    var depths = new WildernessPlane({width: 1024, height: 1024, upstairs: plane})
    var such_depths = new WildernessPlane({width: 1024, height: 1024, upstairs: depths})
    top.plane = plane
