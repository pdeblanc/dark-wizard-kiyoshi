...
Being
    .kingdom({name: 'animal', generic: true, bias: -5, corpse: universe.products.meat})
        .phylum({name: 'human', symbol: '人', lean_mass: 100, attacks: [{punch: 1}], inventory: {width: 2, height: 9}, level: 0.5, playable: true, bias: -6, habitat: {town: 2}})
            .clazz({name: 'samurai', symbol: '侍', attacks: [{cut: 3}], playable: false, level: 1.5})
        .phylum({name: 'three-clawed dragon', symbol: '竜', lean_mass: 10000, vigor: 100, attacks: [{burn: 10}], can_fly: true, inventory: {width: 1, height: 3}, level: 50})
            .clazz({name: 'four-clawed dragon', symbol: '龍', lean_mass: 20000, vigor: 141, attacks: [{burn: 14}], level: 99})
                .order({name: 'five-clawed dragon', symbol: '龍', lean_mass: 40000, vigor: 200, attacks: [{burn: 20}], level: 200})
        .phylum({name: 'cat', symbol: '猫', lean_mass: 10, vigor: 3, attacks: [{scratch: 1}], playable: true, level: 0.15})
        .phylum({name: 'dog', symbol: '犬', lean_mass: 30, vigor: 5, attacks: [{bite: 1}], playable: true, level: 0.25})
        .phylum({name: 'mouse', symbol: '鼠', lean_mass: 0.1, vigor: 0.3, speed: 30, attacks: [{bite: .1}], level: 0.0045})
            .clazz({name: 'rat', symbol: '鼠', lean_mass: 1, vigor: 1, speed: 20, attacks: [{bite: .2}], level: 0.02})
        .phylum({name: 'bird', symbol: '鳥', lean_mass: 0.1, vigor: 0.2, speed: 30, attacks: [{peck: .1}], can_fly: true, playable: true, level: 0.003})
        ...
        .phylum({name: 'fish', symbol: '魚', lean_mass: 2, vigor: 2, attacks: [{bite: 0.2}], can_walk: false, can_swim: true, playable: true, level: 0.02})
            ...
            .clazz({name: 'shark', symbol: '鮫', generic: true})
                ...
                .order({name: 'megalodon', lean_mass: 90000, vigor: 300, attacks: [{bite: 30}], level: 450})
        .phylum({name: 'battleship', symbol: '艦', lean_mass: 20000000, vigor: 4472, attacks: [{shoot: 300}], can_walk: false, can_swim: true, level: 67080, inventory: {width: 4, height: 9}, corpse: universe.products.iron})
        .phylum({name: 'fire being', symbol: '火', lean_mass: 100, speed: 15, attacks: [{burn: 3}], level: 2.25, corpse: universe.products.ash})
