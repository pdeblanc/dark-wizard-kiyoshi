...
Item.variant({name: 'katana', symbol: '刀', action: 'toggle_wield', attack: {cut: 5}})
universe.products.katana.variant({name: 'bokutō', attack: {hit: 2}})
Item.variant({name: 'longsword', symbol: '剣', action: 'toggle_wield', attack: {cut: 5}})
Item.variant({name: 'meat', symbol: '肉', fat: 2, action: 'eat', attack: {slap: .5}})
