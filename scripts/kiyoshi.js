...
Being
    .kingdom({name: 'animal', generic: true, bias: -5, corpse: universe.products.meat})
        .phylum({name: 'human', symbol: '人', lean_weight: 100, hands: 2, attacks: [{punch: 1}], inventory: {width: 2, height: 9}, level: 0.5, playable: true, bias: -6, habitat: {town: 2}})
            .clazz({name: 'samurai', symbol: '侍', attacks: [{cut: 3}], playable: false, level: 1.5})
        .phylum({name: 'three-clawed dragon', symbol: '竜', hands: 2, lean_weight: 10000, vigor: 100, attacks: [{burn: 10}], can_fly: true, inventory: {width: 1, height: 3}, level: 50})
