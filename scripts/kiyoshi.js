...
Being
    .kingdom({name: 'animal', generic: true, bias: -5, corpse: universe.products.meat})
        ...
        .phylum({name: 'dog', symbol: '犬', lean_weight: 30, vigor: 5, power: 5, attacks: [universe.attacks.bite], playable: true, level: 0.25, generic: true})
            .clazz({name: 'golden retriever', lean_weight: 50, vigor: 7, power: 7, playable: false, level: 0.35})
            .clazz({name: 'rottweiler', lean_weight: 80, vigor: 9, power: 9, playable: false, level: 0.4})
        ...
        .phylum({name: 'fish', symbol: '魚', lean_weight: 2, vigor: 2, power: 0.2, attacks: [universe.attacks.bite], can_walk: false, can_swim: true, playable: false, level: 0.02})
